...
<section class="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md ">
    <h1 class="text-xl font-bold text-white capitalize">Assign Request</h1>
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div className='col-span-1'>
                <label class="text-white  " for="username">Dr. Full Name</label>
            ...
            <div className='col-span-1'>
                <label class="text-white  " for="username">Dr. Last Name</label>
                <input id="username" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md    focus:border-blue-500  focus:outline-none focus:ring"/>
            </div>
            ...
            <div className='col-span-2'>
                <label class="text-white " for="passwordConfirmation">Mode of Consultation</label>
                <select class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md  focus:border-blue-500  focus:outline-none focus:ring">
