...
export default function Home() {
  ...
  <div class="min-h-screen grid grid-cols-2 p-5">
  <div class="row1col1">
  <a href="#" class="block w-full ml-2  p-5 hover:border-2  hover:border-accent-green bg-gray-100 border   rounded-lg shadow-xl hover:bg-gray-100">
...
Welcome to Wellness Nexus, where we're dedicated to transforming healthcare resource management for a healthier world. Our mission is to revolutionize the way healthcare entities coordinate, allocate resources, and provide efficient patient care, regardless of the challenges that arise.
  ...
  <div class="row2col2 ">
  <a href="#" class="block w-full pt-10 p-6 hover:border-2  hover:border-accent-green bg-gray-100 border -ml-6 -mt-10  rounded-lg shadow-xl hover:bg-gray-100">
  ...
  <div class=" row3col1">
  <a href="#" class="block w-full pt-10 p-6 bg-gray-100 border -mr-8 -mt-8 hover:border-2  hover:border-accent-green  rounded-lg shadow-xl hover:bg-gray-100">
