                            ...
                            <div class="bg-white rounded shadow-lg  shadow-teal-500  p-4 px-4 md:p-8 mb-6">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                                    <div class="text-gray-600">
                                        <p class="font-extrabold text-xl mb-3">Hospital Details</p>
                                    ...
                                    <div class="lg:col-span-2">
                                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            <div class="md:col-span-5">
                                                ...
                                                <input type="text" name="full_name" id="full_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  placeholder="Anand Hospital" />
                                            </div>
                                            ...
                                            <div class="md:col-span-3">
                                                <label for="zipcode">Number of Doctors</label>
